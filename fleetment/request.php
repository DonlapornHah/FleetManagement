            ...
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                ...
                <div>
                    <div class="btn-group btn-group-sm" role="group" aria-label="plan type toggle">
                        <input type="radio" class="btn-check" name="plan_type[${br_id}]" id="plan_type_standard_${br_id}" value="standard" autocomplete="off" checked onchange="onPlanTypeChange('${br_id}')">
                        <label class="btn btn-outline-light" for="plan_type_standard_${br_id}">แผนมาตรฐาน</label>
                        <input type="radio" class="btn-check" name="plan_type[${br_id}]" id="plan_type_special_${br_id}" value="special" autocomplete="off" onchange="onPlanTypeChange('${br_id}')">
                        <label class="btn btn-outline-warning" for="plan_type_special_${br_id}">แผนที่บันทึกไว้</label>
                    </div>
                </div>
            </div>
            <div class="card-body">
    ...
    if (e.target && e.target.id === 'all-route-form') {
        ...
        Object.entries(request).forEach(([br_id, obj]) => {
            ...
            if (standardRadio && standardRadio.checked) {
                ...
                if (!planNameInput || planNameInput.value !== 'คิวมาตรฐานของสาย ' + br_id) {
